                ...
                <?php else: ?>
                    ...
                    <?php if ($categoryLookupFailures > 0): ?>
                        <div class="form-text mt-2">
                            <?= (int)$categoryLookupFailures ?> model<?= $categoryLookupFailures === 1 ? '' : 's' ?> could not be mapped to a local inventory category and were grouped as "Unknown category".
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    const scrollKey = 'kitgrab:reportsSortScrollY';
