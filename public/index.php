                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text">
                                Perform ad-hoc bulk checkouts via local inventory without selecting a reservation.
                            </p>
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text">
                                Scan asset tags to check items back in via local inventory (quick scan style).
                            </p>
