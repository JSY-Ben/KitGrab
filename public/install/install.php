...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$installLocked) {
    ...
    if ($configExists && !isset($_POST['overwrite_ok']) && $action === 'save') {
        ...
        $newConfig['app'] = [
            ...
            'overdue_staff_email'   => '',
            'notification_overdue_user_template_html' => layout_notification_template_definitions()['overdue_user']['default'],
            'notification_overdue_staff_template_html' => layout_notification_template_definitions()['overdue_staff']['default'],
            'overdue_staff_name'    => '',
            'notification_reservation_submitted_enabled' => true,
            'notification_reservation_submitted_send_user' => true,
            'notification_reservation_submitted_send_checkout_users' => true,
            'notification_reservation_submitted_send_admins' => true,
            'notification_reservation_submitted_extra_emails' => '',
            'notification_reservation_submitted_template_html' => layout_notification_template_definitions()['reservation_submitted']['default'],
            'notification_quick_checkout_enabled' => true,
            'notification_quick_checkout_send_user' => true,
            'notification_quick_checkout_send_staff' => true,
            'notification_quick_checkout_extra_emails' => '',
            'notification_quick_checkout_template_html' => layout_notification_template_definitions()['quick_checkout']['default'],
            'notification_staff_checkout_enabled' => true,
            'notification_staff_checkout_send_user' => true,
            'notification_staff_checkout_send_staff' => true,
            'notification_staff_checkout_extra_emails' => '',
            'notification_staff_checkout_template_html' => layout_notification_template_definitions()['staff_checkout']['default'],
            'notification_quick_checkin_enabled' => true,
            'notification_quick_checkin_send_user' => true,
            'notification_quick_checkin_send_staff' => true,
            'notification_quick_checkin_extra_emails' => '',
            'notification_quick_checkin_template_html' => layout_notification_template_definitions()['quick_checkin']['default'],
            ...
            'notification_mark_missed_template_html' => layout_notification_template_definitions()['mark_missed']['default'],
            'notification_new_user_enabled' => true,
            'notification_new_user_send_admins' => true,
            'notification_new_user_extra_emails' => '',
            'notification_new_user_template_html' => layout_notification_template_definitions()['new_user_registered']['default'],
            'notification_welcome_approved_template_html' => layout_notification_template_definitions()['welcome_user_approved']['default'],
            'notification_welcome_pending_template_html' => layout_notification_template_definitions()['welcome_user_pending']['default'],
            'notification_user_approved_template_html' => layout_notification_template_definitions()['user_account_approved']['default'],
            'block_catalogue_overdue' => true,
            'catalogue_cache_ttl'   => 0,
