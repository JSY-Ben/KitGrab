...
return [
    ...
    'app' => [
        ...
        'notification_new_user_template_html' => '<p>A new user account has been created.</p><p><strong>Name:</strong> {{person_name}}<br><strong>Email:</strong> {{person_email}}<br><strong>Username:</strong> {{username}}<br><strong>Approval status:</strong> {{approval_status}}</p><p><strong>Click here to approve the newly registered user:</strong><br>{{users_admin_link}}</p>',
